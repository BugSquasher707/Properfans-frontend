  ...
  return (
    <>
      ...
      >
        <div
          ref={ref}
          className={`pre-r relative overflow-hidden rounded-4 ${light ? "bg-grey-3" : "bg-grey-10 dark:bg-white-10"}`}
        ...
        >
          <ReactPlayer
            ...
            light={pre}
            muted={muted}
            playIcon={<VideoPlayIcon length={length} setPlaying={setPlaying} title={title} />}
            playing={playing}
