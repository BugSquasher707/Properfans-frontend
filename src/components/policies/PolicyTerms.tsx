  ...
  return (
    <>
      <div className="w-full">
        <PolicyDownload
          data={{
            link: "/documents/ProperfansTermsAndConditions.pdf",
            title: "Terms of Service"
          }}
        />
        <div className="mb-16 w-full text-14 font-bold text-black" id="agreement">
        ...
        <div className="mb-20 w-full text-14 text-grey-40">
          ...
          an entity (“you”) and Ellingsen Group AS, doing business as Properfans (
          <span className="font-bold text-black">&quot;Properfans&quot;</span>,{" "}
          <span className="font-bold text-black">&quot;we&quot;</span>,{" "}
          <span className="font-bold text-black">&quot;us&quot;</span>,{" "}
          <span className="font-bold text-black">&quot;our&quot;</span>), concerning your access to and use of the{" "}
          ...
          or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have
        ...
        <div className="mb-20 w-full text-14 text-grey-40">
          ...
          changes in any revised Terms of Use by your continued use of the Site after the date such revised Terms of Use
          are posted.
        </div>
        <div className="mb-20 w-full text-14 text-grey-40">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="property">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="representation">
        ...
        <div className="mb-20 w-full text-14 text-grey-40">
          ...
          Terms of Use; (4) you are not under the age of 13; (5) you are not a minor in the jurisdiction in which you
          reside, or if a minor, you have received parental permission to use the Site; (6) you will not access the Site
          through automated or non-human means, whether through a bot, script, or otherwise; (7) you will not use the
          Site for any illegal or unauthorized purpose; and (8) your use of the Site will not violate any applicable law
          or regulation.
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="registration">
          4. USER REGISTRATION
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="activities">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="contributions">
        ...
        <div className="mb-20 w-full text-14 text-grey-40">
          <ul className="list-inside list-decimal">
            ...
            <li>our Contributions do not ridicule, mock, disparage, intimidate, or abuse anyone.</li>
            <li>
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="license">
          7. CONTRIBUTION LICENSE
        </div>
        <div className="mb-20 w-full text-14 text-grey-40">
          By posting your Contributions to any part of the Site or making Contributions accessible to the Site by
          linking your account from the Site to any of your social networking accounts, you automatically grant, and you
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="reviews">
          8. GUIDELINES FOR REVIEWS
        </div>
        <div className="mb-20 w-full text-14 text-grey-40">
          We may provide you areas on the Site to leave reviews or ratings. When posting a review, you must comply with
          the following criteria: (1) you should have firsthand experience with the person/entity being reviewed; (2)
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="media">
          9. SOCIAL MEDIA
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
          ...
          Third-Party Account login information through the Site; or (2) allowing us to access your Third-Party Account,
          ...
          Account. By granting us access to any Third-Party Accounts, you understand that (1) we may access, make
          ...
          to, for accuracy, legality, or non-infringement, and we are not responsible for any Social Network Content.
          ...
          informing you of those contacts who have also registered to use the Site. You can deactivate the connection
          between the Site and your Third-Party Account by contacting us using the contact information below or through
          your account settings (if applicable). We will attempt to delete any information stored on our servers that
          was obtained through such Third-Party Account, except the username and profile picture that become associated
          with your account.
        </div>
        <div className="mb-16 w-full text-14 font-bold text-black" id="submissions">
          10. SUBMISSIONS
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="content">
        ...
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
          ...
          purchases which are exclusively between you and the applicable third party. You agree and acknowledge that we
          do not endorse the products or services offered on Third-Party Websites and you shall hold us harmless from
          any harm caused by your purchase of such products or services. Additionally, you shall hold us harmless from
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="advertisers">
          12. ADVERTISERS
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="management">
          13. SITE MANAGEMENT
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="privacy">
          14. PRIVACY POLICY
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
          We care about data privacy and security. Please review our{" "}
          <Link className="font-bold text-purple" to={URL.POLICIES.PRIVACY}>
            Privacy Policy
          </Link>
          . By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of
          Use. Please be advised the Site is hosted in Norway. If you access the Site from any other region of the world
          with laws or other requirements governing personal data collection, use, or disclosure that differ from
          applicable laws in Norway, then through your continued use of the Site, you are transferring your data to
          Norway, and you agree to have your data transferred to and processed in Norway. Further, we do not knowingly
          accept, request, or solicit information from children or knowingly market to children. Therefore, in
          accordance with the U.S. Children’s Online Privacy Protection Act, if we receive actual knowledge that anyone
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="copyright">
        ...
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
          ...
          who posted or stored the material addressed in the Notification. Please be advised that pursuant to applicable
          law you may be held liable for damages if you make material misrepresentations in a Notification. Thus, if you
          are not sure that material located on or linked to by the Site infringes your copyright, you should consider
          first contacting an attorney.
        </div>
        <div className="mb-16 w-full text-14 font-bold text-black" id="termination">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="modifications">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="law">
          18. GOVERNING LAW
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
          These conditions are governed by and interpreted following the laws of Norway, and the use of the United
          Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual
          residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by
          obligatory provisions of the law of your country of residence. Ellingsen Group AS and yourself both agree to
          submit to the non-exclusive jurisdiction of the courts of Innlandet, which means that you may make a claim to
          defend your consumer protection rights in regards to these Conditions of Use in Norway, or in the EU country
          in which you reside.
        </div>
        <div className="mb-16 w-full text-14 font-bold text-black" id="dispute">
        ...
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
          ...
          <Link
            ...
            to="route"
            onClick={(event) => {
              openLink(event, "https://ec.europa.eu/consumers/odr")
            }}
          >
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="corrections">
          20. CORRECTIONS
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="disclaimer">
          21. DISCLAIMER
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="liability">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="indemnification">
          23. INDEMNIFICATION
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="user">
          24. USER DATA
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="electronic">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="california">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="miscellaneous">
          27. MISCELLANEOUS
        </div>
        <div className="mb-20 w-full text-14 text-grey-40 lg:mb-40">
        ...
        <div className="mb-16 w-full text-14 font-bold text-black" id="contact">
          28. CONTACT US
        </div>
        <div className="mb-20 w-full text-14 text-grey-40">
        ...
        <div className="w-full text-14 text-grey-40">
          <span className="font-bold text-black">Ellingsen Group AS</span>
          <br />
          <span className="font-bold text-black">Markensvegen, Kongsvinger, Norway</span>
          <br />
          <span className="font-bold text-black">Kongsvinger, Innlandet 2212</span>
          <br />
          <span className="font-bold text-black">Norway </span>
          <br />
          <span className="font-bold text-black">Phone: (+47)98996899</span>
          <br />
          <Link
            ...
            to="route"
            onClick={(event) => {
              openLink(event, "mailto:contact@properfans.com")
            }}
          >
            contact@properfans.com
          </Link>
        </div>
      </div>
    </>
